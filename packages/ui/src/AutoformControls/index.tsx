import { useLang } from '@react-page/core';
import {
  CellPluginControlsProps,
  CellPluginRendererProps,
...
function AutoformControls<T extends object>(props: CellPluginControlsProps<T>) {
  const lang = useLang();
